...
public static class ConditionGroupClauseWhere
{
    ...
    public static ConditionClause WhereAnd(this ConditionGroupClause source, string sourcevalue, string sign, string destinationvalue) => source.Where("and", sourcevalue, sign, destinationvalue);
